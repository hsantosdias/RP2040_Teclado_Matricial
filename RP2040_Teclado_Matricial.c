...
uint8_t rowPins[ROWS] = {18, 19, 20, 4};  // GPIOs para as linhas
uint8_t colPins[COLS] ={16, 17, 9, 8};  // GPIOs para as colunas
...
int main() {
    ...
    MatrixKeypad_t *keypad = MatrixKeypad_create((char *)keyMap, rowPins, colPins, ROWS, COLS);
    if (keypad == NULL) {
